...
var UelzenTV_1 = require("./Services/Uelzen-TV/UelzenTV");
// Require constants
...
var Main = /** @class */ (function () {
    function Main() {
        ...
        if (Configuration.Services.UelzenTV.Enabled) {
            this.RegisterService(new UelzenTV_1.UelzenTV());
        }
        this.Inital_Load();
    }
    Main.prototype.Inital_Load = function () {
    ...
    Main.prototype.LoadServiceDataStorage = function () {
    ...
    Main.prototype.SaveServiceDataStorage = function () {
